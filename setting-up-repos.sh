...
ENGRAVING_DIR="/Users/elaine/git/engraving"
SONG_DIR="$ENGRAVING_DIR/$SONG"
...
echo "-=-"
echo "Clone the lilypond repo $LILYPOND_REPO_URL into $ENGRAVING_DIR"
cd $ENGRAVING_DIR
...
echo "-=-"
echo "Copy over commit script to $SONG_DIR"
cp ~/git/engraving/commit.sh $SONG_DIR
