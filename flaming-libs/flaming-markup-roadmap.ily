...
dsAlCodaMarkup = \markup { \bold \huge "D.S. al" \translate #'(-2 . 0.8) \small \musicglyph "scripts.coda" }
dsAlCoda = <>^\dsAlCodaMarkup
...
dSolosAABA = <>_\markup { \bold \huge "Solos: AABA" } 
...
startRepeatLabel = #(define-music-function
    (repeatLabel)
    (markup?)
    #{
        \showMeasureNumber
        \mark \markup { \bold #repeatLabel } 
    #})
