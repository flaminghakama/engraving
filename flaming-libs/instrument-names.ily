...
sopranoSaxophoneInBbNameOnly = \markup \concat  { "Soprano Saxophone in B" \teeny " " \raise #0.6 \flat }
soloSopranoSaxophoneInBbNameOnly = \markup \concat  { "Solo Soprano Saxophone in B" \teeny " " \raise #0.6 \flat }
soloSopSaxInBbNameOnly = \markup \concat { "Solo Sop. Sax in B" \raise #0.6 \flat }
altoSaxophoneForEnglishHornNameOnly = \markup \center-column { \concat { "Alto Saxophone in E" \raise #0.6 \flat } "( for English Horn )"}
soloAltoSaxophoneInEbNameOnly = \markup \concat { "Solo Alto Saxophone in E" \hspace #0.1 \raise #0.35 \flat }
soloAltoSaxInEbNameOnly = \markup \concat { "Solo Alto Sax in E" \hspace #0.1 \raise #0.35 \flat }
...
soloTenorSaxophoneInBbNameOnly = \markup \concat { "Solo Tenor Saxophone in B" \hspace #0.1 \raise #0.35 \flat }
soloTenorSaxInBbNameOnly = \markup \concat { "Solo Tenor Sax in B" \hspace #0.1 \raise #0.35 \flat }
...
sopranoSaxophoneInBbName = \markup \formatInstrumentName \sopranoSaxophoneInBbNameOnly
soloSopranoSaxophoneInBbName = \markup \formatInstrumentName \soloSopranoSaxophoneInBbNameOnly
soloSopSaxInBbName = \markup \formatInstrumentName \soloSopSaxInBbNameOnly
altoSaxophoneForEnglishHornName = \markup \formatInstrumentName \altoSaxophoneForEnglishHornNameOnly
soloAltoSaxophoneInEbName = \markup \formatInstrumentName \soloAltoSaxophoneInEbNameOnly
soloAltoSaxInEbName = \markup \formatInstrumentName \soloAltoSaxInEbNameOnly
...
soloTenorSaxophoneInBbName = \markup \formatInstrumentName \soloTenorSaxophoneInBbNameOnly
soloTenorSaxInBbName = \markup \formatInstrumentName \soloTenorSaxInBbNameOnly
...
sopranoSaxophoneInBbTitle = \markup \formatInstrumentTitle \sopranoSaxophoneInBbNameOnly
soloSopranoSaxophoneInBbTitle = \markup \formatInstrumentTitle \soloSopranoSaxophoneInBbNameOnly
soloSopSaxInBbTitle = \markup \formatInstrumentTitle \soloSopSaxInBbNameOnly
altoSaxophoneForEnglishHornTitle = \markup \formatInstrumentTitle \altoSaxophoneForEnglishHornNameOnly
soloAltoSaxophoneInEbTitle = \markup \formatInstrumentTitle \soloAltoSaxophoneInEbNameOnly
soloAltoSaxInEbTitle = \markup \formatInstrumentTitle \soloAltoSaxInEbNameOnly
...
soloTenorSaxophoneInBbTitle = \markup \formatInstrumentTitle \soloTenorSaxophoneInBbNameOnly
soloTenorSaxInBbTitle = \markup \formatInstrumentTitle \soloTenorSaxInBbNameOnly
